...
const sentences = {
    ...
    //매인 타이틀
    main_upper_title: ["Make your broadcast more fun", "당신의 방송을 더욱 재밌게"],
    ...
    // Login 화면
    login_title: ["Easy to broadcast, Enjoyable for viewers", "방송을 편하게, 시청자는 즐겁게"],
    login_description_1: [
    ...
    voteform_placeholder: ["Please enter your voting item", "투표 항목을 입력후 엔터를 누르세요!"],
    ...
    vote_has_empty: ["Blank spaces cannot be voting items.", "빈 칸은 투표 항목이 될 수 없습니다."],
    ...
    voteform_guide_1_1: ["Please enter the voting items.", "투표 항목들을 입력해주세요."],
    voteform_guide_1_2: ["You can enter multiple items.", "항목은 여러개를 입력 할 수 있습니다."],
    voteform_guide_2: ["Press button to start voting.", "버튼을 눌러 투표를 시작하세요."],
    vote_guide_1_1: [
    ...
    manual_vote_2_3: ["3. You can hide your current vote.", "3. 현재 투표를 감출 수 있습니다."],
    manual_vote_2_4: [
...
export function convert() {
    ...
    for (const property in sentences) {
        ret[property] = sentences[property][index];
    }
...
export class LangProvider extends React.Component {
    ...
    render() {
        return <React.Fragment>{convert()[this.state.key]}</React.Fragment>;
    }
}
