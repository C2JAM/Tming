  ...
  componentDidMount = async () => {
    ...
    try {
      const fetched = await fetch(
        `https://api.twitch.tv/helix/moderation/banned?broadcaster_id=${this.state.broadcaster_id}`,
        {
          method: 'GET',
          headers: {
    ...
    try {
      const fetched = await fetch(
        `https://api.twitch.tv/helix/moderation/moderators?broadcaster_id=${this.state.broadcaster_id}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${this.state.accessToken}`,
