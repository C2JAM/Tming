            ...
            <React.Fragment>
                <div className="full-screen-page" style={{ background: "" }}>
                    {this.state.chart_type === "pie_1" ? (
                        <ReactApexChart
                            options={this.templatePieOption(this.state.datalabels_number_type)}
                    ...
                    {this.state.chart_type === "bar_1" ? (
                        <ReactApexChart
                            options={this.templateBarOption(this.state.datalabels_number_type)}
                            series={this.state.seriesBar}
                            type="bar"
                            height="85%"
                        />
                    ) : null}
                    {this.state.chart_type === "voteEnd" ? <VoteEnd>End Voting</VoteEnd> : null}
                </div>
            </React.Fragment>
        );
    }
